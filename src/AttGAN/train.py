...
default_att_names = ['has_primary_color_blue', 'has_primary_color_brown', 'has_primary_color_black', 'has_primary_color_grey','has_primary_color_white', 'has_underparts_color_white', 'has_underparts_color_grey', 'has_underparts_color_blue','has_underparts_color_black', 'has_underparts_color_brown']

py.arg('--att_names', choices=data.ATT_ID.keys(), nargs='+', default=default_att_names)

py.arg('--img_dir', default='./data/images/256x256')
...
py.arg('--n_epochs', type=int, default=20)
py.arg('--epoch_start_decay', type=int, default=10)
py.arg('--batch_size', type=int, default=35)
...
py.arg('--n_samples', type=int, default=20)
